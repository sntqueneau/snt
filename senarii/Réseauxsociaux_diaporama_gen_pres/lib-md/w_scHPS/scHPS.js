	...
	onLoad : function() {
		try{
			...
			if (this.fToolsPath){
				...
				// wipCSS
				this.fBtnEfcts.style.display = (this.fEnableEffects || this.fEnableCssEffects ? "none" : "");
				this.fBtnNoEfcts = this.xAddBtn(this.fTools, "btnNoEfcts", scHPS.xGetStr(11), scHPS.xGetStr(13));

				// wipCSS
				this.fBtnNoEfcts.style.display = (this.fEnableEffects && !this.fEnableCssEffects ? "" : "none");
